...
variable "api_server_authorized_ip_ranges" {
  description = "CIDRs autorizados a alcanzar el API server de AKS. Vacío = abierto a internet (default académico). En stage idealmente poblar con tu IP corporativa."
  type        = list(string)
  default     = []
}
...
variable "psa_enforce_level" {
  description = "Pod Security Admission enforce level."
  type        = string
  default     = "baseline"
}

variable "psa_audit_level" {
  description = "Pod Security Admission audit level."
  type        = string
  default     = "restricted"
}

variable "psa_warn_level" {
  description = "Pod Security Admission warn level."
  type        = string
  default     = "restricted"
}
...
variable "cluster_issuer_kind" {
  description = "ACME in stage so renewals are exercised, but Let's Encrypt staging URL avoids hitting prod rate limits."
  type        = string
  default     = "acme"
}
...
variable "cluster_issuer_acme_server" {
  description = "ACME directory URL. Defaults to Let's Encrypt staging in this env."
  type        = string
